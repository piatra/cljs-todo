...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__2950__auto__ = reader;if(and__2950__auto__)
...
{var x__3554__auto__ = (((reader == null))?null:reader);return (function (){var or__2959__auto__ = (cljs.reader.read_char[goog.typeOf(x__3554__auto__)]);if(or__2959__auto__)
{return or__2959__auto__;
} else
{var or__2959__auto____$1 = (cljs.reader.read_char["_"]);if(or__2959__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__2950__auto__ = reader;if(and__2950__auto__)
...
{var x__3554__auto__ = (((reader == null))?null:reader);return (function (){var or__2959__auto__ = (cljs.reader.unread[goog.typeOf(x__3554__auto__)]);if(or__2959__auto__)
{return or__2959__auto__;
} else
{var or__2959__auto____$1 = (cljs.reader.unread["_"]);if(or__2959__auto____$1)
{return or__2959__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__3495__auto__,writer__3496__auto__,opt__3497__auto__){return cljs.core._write.call(null,writer__3496__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__2959__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__4913){
var rdr = cljs.core.first(arglist__4913);
var msg = cljs.core.rest(arglist__4913);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__2950__auto__ = !((ch === "#"));if(and__2950__auto__)
{var and__2950__auto____$1 = !((ch === "'"));if(and__2950__auto____$1)
{var and__2950__auto____$2 = !((ch === ":"));if(and__2950__auto____$2)
...
{{
var G__4914 = (function (){sb.append(ch);
return sb;
})();
var G__4915 = cljs.reader.read_char.call(null,rdr);
sb = G__4914;
ch = G__4915;
continue;
}
...
{{
var G__4916 = cljs.reader.read_char.call(null,rdr);
ch = G__4916;
continue;
}
} else
...
var G__4917 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__4917;
continue;
}
} else
...
var G__4918 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__4918;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__2959__auto__ = (ch == null);if(or__2959__auto__)
{return or__2959__auto__;
} else
{var or__2959__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__2959__auto____$1)
{return or__2959__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__2959__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
...
{{
var G__4919 = (function (){buffer.append(ch);
return buffer;
})();
var G__4920 = cljs.reader.read_char.call(null,reader);
buffer = G__4919;
ch = G__4920;
continue;
}
...
{if(("\\" === ch))
{{
var G__4921 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__4922 = cljs.reader.read_char.call(null,reader);
buffer = G__4921;
ch = G__4922;
continue;
}
...
{{
var G__4923 = (function (){buffer.append(ch);
return buffer;
})();
var G__4924 = cljs.reader.read_char.call(null,reader);
buffer = G__4923;
ch = G__4924;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__4926 = o;if(G__4926)
{var bit__3570__auto__ = (G__4926.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3570__auto__) || (G__4926.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__4926.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__4926);
} else
{return false;
}
}
...
{{
var G__4927 = reader;
var G__4928 = eof_is_error;
var G__4929 = sentinel;
var G__4930 = is_recursive;
reader = G__4927;
eof_is_error = G__4928;
sentinel = G__4929;
is_recursive = G__4930;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__4931 = cljs.reader.read_comment.call(null,reader,ch);
var G__4932 = eof_is_error;
var G__4933 = sentinel;
var G__4934 = is_recursive;
reader = G__4931;
eof_is_error = G__4932;
sentinel = G__4933;
is_recursive = G__4934;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__4935 = reader;
var G__4936 = eof_is_error;
var G__4937 = sentinel;
var G__4938 = is_recursive;
reader = G__4935;
eof_is_error = G__4936;
sentinel = G__4937;
is_recursive = G__4938;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__2950__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__2950__auto__))
{var or__2959__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__4941 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__4941,0,null);var years = cljs.core.nth.call(null,vec__4941,1,null);var months = cljs.core.nth.call(null,vec__4941,2,null);var days = cljs.core.nth.call(null,vec__4941,3,null);var hours = cljs.core.nth.call(null,vec__4941,4,null);var minutes = cljs.core.nth.call(null,vec__4941,5,null);var seconds = cljs.core.nth.call(null,vec__4941,6,null);var fraction = cljs.core.nth.call(null,vec__4941,7,null);var offset_sign = cljs.core.nth.call(null,vec__4941,8,null);var offset_hours = cljs.core.nth.call(null,vec__4941,9,null);var offset_minutes = cljs.core.nth.call(null,vec__4941,10,null);var v = vec__4941;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__2959__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__2959__auto__))
{return or__2959__auto__;
} else
{return 0;
}
...
{var vec__4943 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__4943,0,null);var months = cljs.core.nth.call(null,vec__4943,1,null);var days = cljs.core.nth.call(null,vec__4943,2,null);var hours = cljs.core.nth.call(null,vec__4943,3,null);var minutes = cljs.core.nth.call(null,vec__4943,4,null);var seconds = cljs.core.nth.call(null,vec__4943,5,null);var ms = cljs.core.nth.call(null,vec__4943,6,null);var offset = cljs.core.nth.call(null,vec__4943,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
